      ...
      DO IT=1,NBDT
          ...
          CALL GASTRANS2(CGO2(:,isa),DPRO,CUPO,DCAO,FLXO2)    ! CGO2 modified to CGO2(:,isa) - Luca Doro
          ! MOVE CO2 AND STORE VALUES OF GAS CONC. IN 2-DIM ARRAY
          CALL GASTRANS2(CGCO2(:,isa),DPRC,CUPC,DCAC,FLXCO2)    ! CGCO2 modified to CGCO2(:,isa) - Luca Doro
          ! MOVE N2O AND STORE VALUES OF GAS CONC. IN 2-DIM ARRAY
          CALL GASTRANS2(CGN2O(:,isa),DPRN,CUPN,DCAN,FLXN2O)    ! CGN2O modified to CGN2O(:,isa) - Luca Doro
