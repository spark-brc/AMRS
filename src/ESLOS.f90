...
!     TO A THICKNESS OF 10 MM, IT IS PLACED INTO THE THIRD LAYER.
      ...
      WNO3(ISL,ISA)=WNO3(ISL,ISA)+WNO3(K,ISA)
      WNH3(ISL,ISA)=WNH3(ISL,ISA)+WNH3(K,ISA)
      ...
      CALL SPOFC(ISL)
      SWST(ISL,ISA)=SWST(ISL,ISA)+SWST(K,ISA)
...
!     BDM(L1,ISA)=WFN(BDM(L1,ISA),BDM(ISL,ISA),W1,W2,Z(L1,ISA))
      ...
      WNO3(L1,ISA)=WNO3(L1,ISA)+EAJL(WNO3(ISL,ISA),W2)
      WNH3(L1,ISA)=WNH3(L1,ISA)+EAJL(WNH3(ISL,ISA),W2)
      ...
      SOLK(L1,ISA)=SOLK(L1,ISA)+EAJL(SOLK(ISL,ISA),W2)
      EXCK(L1,ISA)=EXCK(L1,ISA)+EAJL(EXCK(ISL,ISA),W2)
      FIXK(L1,ISA)=FIXK(L1,ISA)+EAJL(FIXK(ISL,ISA),W2)
      SWST(L1,ISA)=SWST(L1,ISA)+EAJL(SWST(ISL,ISA),W2)
