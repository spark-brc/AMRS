      ...
      SELECT CASE(IPCD)
          CASE(1) ! C
              ...
              ELSE    
                  ...
                  X3=.001*VQC(IDNF(I))
              END IF 
              V75=.001*VAR(75,I)*WSAX
              V140=.001*VAR(140,I)*WSAX
              V99=.001*VAR(99,I)*WSAX
              V73=.001*VAR(73,I)
              V101=.001*VAR(101,I)*WSAX
              V136=.001*VAR(136,I)
          ...
          CASE(3) ! P
              ...
              IF(ABS(BAL)>1.)THEN
                  ...
                  ZPMA(I),ZPO(I),ZFOP(I),ZPMU(I),ZPOU(I),TOT,STDOP(I),ADD,FTP
          ...
          CASE(4) ! N
              ...
              SUM=ZNO3(I)+ZNH3(I)+ZON(I)+TOT+STDON(I)+ADD+ZNMU(I)+ZNOU(I)
              FTN=SUM*WSAX+GWSN(I)
              ...
              IF(ABS(BAL)>0.)THEN
                  ...
                  TOT,STDON(I),ADD,ZNMU(I),ZNOU(I),SUM,GWSN(I),FTN
