...
*     Global module -------------------------------------------------------------------------------
     ...
     &          INBTN,INADV,INDSP,INSSM,INRCT,INGCG,INHFF,INSALT,
     &          OUTRES,FNAMES,
...
C       Species arrays
        ...
        !salt
        real, dimension (:,:,:),   allocatable :: saltdissolve_aqu !change in salt mass due to salt mineral precipitation-dissolution (kg)
        real, dimension (:,:,:),   allocatable :: salt_aqu !total salt in cell (kg)
